...
const DaftarNilaiPenilaianAkhirSemester = () => {
  return (
    <div>
        <div>
            <Components.Title title='Penilaian' subtitle='Akhir' endtitle='Semester'/>
        </div>
...
export default DaftarNilaiPenilaianAkhirSemester