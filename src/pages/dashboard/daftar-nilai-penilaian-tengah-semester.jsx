...
const DaftarNilaiPenilaianTengahSemester = () => {
  return (
    <div>
        <div>
            <Components.Title title='Penilaian' subtitle='Tengah' endtitle='Semester'/>
        </div>
...
export default DaftarNilaiPenilaianTengahSemester